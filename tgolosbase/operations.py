...
#https://github.com/bitfag
#https://github.com/bitshares
#https://github.com/golos-blockchain/golos-js/blob/master/src/auth/serializer/src/types.js#L325
...
type_op = {
	...
	"custom_json": 						[['required_auths', ArrayString], ['required_posting_auths', ArrayString], ['id', String], ['json', String]],
	...
	"claim":							[['from', String], ['to', String], ['amount', Amount], ['to_vesting', Bool], ['extensions', Set]],
	
	"donate":							[['from', String], ['to', String], ['amount', Amount], ['memo', DonateMemo], ['extensions', Set]],
	
	"transfer_to_tip":					[['from', String], ['to', String], ['amount', Amount], ['memo', String], ['extensions', Set]],
	"transfer_from_tip":				[['from', String], ['to', String], ['amount', Amount], ['memo', String], ['extensions', Set]],
	"invite":							[['creator', String], ['balance', Amount], ['invite_key', PublicKey], ['extensions', Set]],
	"invite_claim":						[['initiator', String], ['receiver', String], ['invite_secret', String], ['extensions', Set]],
	"account_create_with_invite":		[['invite_secret', String], ['creator', String], ['new_account_name', String], 
										['owner', Permission], ['active', Permission], ['posting', Permission], ['memo_key', PublicKey], 
										['json_metadata', String], ['extensions', Set]],
			}
